...
public final class MirrorLegacyStore<Content: Hashable, ID: RandomizableIdentifier> {
...
// MARK: - MirrorStoring
extension MirrorLegacyStore: MirrorStoring {
...
private extension MirrorLegacyStore {
...
public extension MirrorLegacyStore {
